  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="驾驶员单位" prop="driverDepartment">
        <el-input
          v-model="queryParams.driverDepartment"
          placeholder="请输入驾驶员单位"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="驾驶员准驾机型" prop="driverAircraftSoft">
        <el-input
          v-model="queryParams.driverAircraftSoft"
          placeholder="请输入驾驶员准驾机型"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="驾驶员状态" prop="driverState">
        <el-input
          v-model="queryParams.driverState"
          placeholder="请输入驾驶员状态"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="驾驶员单位" prop="driverDepartment">
          <el-input v-model="form.driverDepartment" placeholder="请输入驾驶员单位" />
        </el-form-item>
        <el-form-item label="驾驶员身份证号" prop="driverIdcard">
        ...
        <el-form-item label="驾驶员准驾机型" prop="driverAircraftSoft">
          <el-input v-model="form.driverAircraftSoft" placeholder="请输入驾驶员准驾机型" />
        </el-form-item>
        <el-form-item label="驾驶员状态" prop="driverState">
          <el-input v-model="form.driverState" placeholder="请输入驾驶员状态" />
        </el-form-item>
        <el-form-item label="驾驶员照片" prop="driverPhoto">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        driverDepartment: [
          { required: true, message: "驾驶员单位不能为空", trigger: "blur" }
        ],
        driverPhone: [
