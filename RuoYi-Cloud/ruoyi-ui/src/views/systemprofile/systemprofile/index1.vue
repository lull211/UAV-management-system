...
export default {
  ...
  props: {
    ...
    aliplayerSdkPath: {
      // Aliplayer 代码的路径
      type: String,
      default: 'https://g.alicdn.com/de/prismplayer/2.6.0/aliplayer-min.js'
    },
    autoplay: {// 播放器是否自动播放
      type: Boolean,
      default: true
    },
    isLive: {// 播放内容是否为直播，直播时会禁止用户拖动进度条。
      type: Boolean,
      default: false
    },
    ...
    source: {
      type: String,
      default: 'http://localhost:81/hls/demo.m3u8'
