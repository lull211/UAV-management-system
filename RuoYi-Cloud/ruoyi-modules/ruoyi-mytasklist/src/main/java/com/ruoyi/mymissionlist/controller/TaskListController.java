package com.ruoyi.mymissionlist.controller;
...
import com.ruoyi.mymissionlist.service.ITaskListService;
...
public class TaskListController extends BaseController
{
     ...
     * 导出任务列表列表
     */
    @PreAuthorize(hasPermi = "mymissionlist:mymissionlist:export")
     ...
     * 获取任务列表详细信息
     */
    @PreAuthorize(hasPermi = "mymissionlist:mymissionlist:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增任务列表
     */
    @PreAuthorize(hasPermi = "mymissionlist:mymissionlist:add")
     ...
     * 修改任务列表
     */
    @PreAuthorize(hasPermi = "mymissionlist:mymissionlist:edit")
     ...
     * 删除任务列表
     */
    @PreAuthorize(hasPermi = "mymissionlist:mymissionlist:remove")
